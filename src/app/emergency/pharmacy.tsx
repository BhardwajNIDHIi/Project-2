...
export default function PharmacyScreen() {
  ...
  const loadPharmacies = async () => {
    ...
    try {
      ...
      if (status !== "granted") {
        ...
        Alert.alert(
          "Location Permission",
          "Nearby pharmacies find karne ke liye location permission required hai."
        );
      ...
      Alert.alert(
        "Pharmacy Error",
        "Nearby pharmacies load nahi ho paayi."
      );
  ...
  const callPharmacy = (
    ...
    if (!phone) {
      ...
      Alert.alert(
        "Phone unavailable",
        "Is pharmacy ka phone number available nahi hai."
      );
